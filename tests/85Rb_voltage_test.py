...
raw_data.read_new_csv('example_data/newDAQtest/scan_597.csv', x_axis_name='First')
raw_data.read_new_csv('example_data/newDAQtest/scan_598.csv', x_axis_name='First')
raw_data.read_cali_csv('example_data/newDAQtest/cali_597.csv')
raw_data.read_cali_csv('example_data/newDAQtest/cali_598.csv')
raw_data.fill_cali('InitEnergy', 'ffill')
raw_data.fill_cali('Diode', 'ffill')
raw_data.dropna()
raw_data.voltage_cali('example_data/newDAQtest/bop_589.csv', is_new=True)
...
rates = raw_data.count_rate(bin_width=12, is_draw=True, save_path='tests/85Rb_voltage_scan_rates.csv')
...
# fit.asymmlorentzian_fit(df = -108, scale=1200, bg = 8.0, is_fit = True, fwhm=500, asymmetryparams={'a': -0.1}, Au_Al_ratio=25.3/1011.9)
