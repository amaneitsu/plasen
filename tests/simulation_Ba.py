...
sim_1 = HFS_simulation(total_yield, total_eff, bg_ratio, time = time_total * 4/7, bin_num=40, scan_range = [-4000,-2000], fit_ini={"type": "scan_ranges", "name": "137Ba", "I": 1.5, "J": [0.5, 1.5], "ABC": [4020.3, 126.7, 0.0, 95.0, 0.0, 0.0], "trans": 21952.404, "fwhm": [40.0, 80.0], "range": 5000, "V": 30000.0, "mass": 136.905827, "laser": 21944.2616})
x_1,y_1,yerr_1 = sim_1.get_result()

sim_2 = HFS_simulation(total_yield, total_eff, bg_ratio, time = time_total * 3/7, bin_num=30, scan_range = [4000,5500], fit_ini={"type": "scan_ranges", "name": "137Ba", "I": 1.5, "J": [0.5, 1.5], "ABC": [4020.3, 126.7, 0.0, 95.0, 0.0, 0.0], "trans": 21952.404, "fwhm": [40.0, 80.0], "range": 5000, "V": 30000.0, "mass": 136.905827, "laser": 21944.2616})
...
n_s = sim_1.model.f(sim_1.model.hfs.pos()[5])[0]
...
bax = brokenaxes(xlims=((-4000, -2000), (4000, 5500)))
bax.errorbar(x, y, yerr, fmt='o', label='scan1', color='k', markersize=3)

x_plot = np.linspace(-4000, 5500, 5000)
