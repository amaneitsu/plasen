...
sim_1 = HFS_simulation(60, 1 / 1000, bg_ratio, time = time_one_side, bin_num=50, scan_range = [-1750,-750], fit_ini={"type": "scan_ranges", "name": "85Rb", "I": 2.5, "J": [0.5, 1.5], "ABC": [1011.0, 25.3, 0.0, 21.4, 0.0, 0.0], "trans": 12816.545, "fwhm": [60.0, 30.0], "range": 2000, "V": 29980.0, "mass": 84.91179, "laser": 12805.391})
x_1,y_1,yerr_1 = sim_1.get_result()

# bg = bg_ratio * 100* 1 / 10 * 0.6 * time_one_side / 50


sim_2 = HFS_simulation(60, 1 / 1000, bg_ratio, time = time_one_side, bin_num=50, scan_range = [1200,2200], fit_ini={"type": "scan_ranges", "name": "85Rb", "I": 2.5, "J": [0.5, 1.5], "ABC": [1011.0, 25.3, 0.0, 21.4, 0.0, 0.0], "trans": 12816.545, "fwhm": [60.0, 30.0], "range": 2000, "V": 29980.0, "mass": 84.91179, "laser": 12805.391})
